	...
	<div class="ccm-dashboard-inner">
	  ...
	  <?php  
			...
			<?php   foreach ($ctArray as $ct) { ?>
				<option value="<?php  echo $ct->getCollectionTypeID()?>" >
            ...
            <br/><br/>
                ...
                <br/>
                <h3><?php   echo t('Exclude pages from navigation? ')?><input type="checkbox" name="exclude_nav" value="1" /></h3>
				<br/>
                <h3><?php   echo t('Exclude pages from page list? ')?><input type="checkbox" name="exclude_page_list " value="1" /></h3>
				<br/>
				<h3><?php   echo t('Exclude pages from search index? ')?><input type="checkbox" name="exclude_search_index" value="1" /></h3>
				<br/>
                <h3><?php   echo t('Exclude pages from sitemap.xml? ')?><input type="checkbox" name="exclude_sitemapxml" value="1" /></h3>
				<br/>
